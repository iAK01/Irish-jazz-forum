...
export function generateForumDigestSubject(payload: ForumDigestPayload) {
  return `Your weekly IJF forum digest: ${payload.threadCount} active thread${
            ...
            <tr>
              <td style="padding: 0 0 14px;">
                ...
                <div style="margin-top: 6px; font-size: 13px; color: #6b7280; line-height: 1.6;">
                  Last activity: ${formatLastActivity(thread.lastActivityAt)} · ${thread.replyCount} repl${
    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 640px; margin: 0 auto; color: #1a1a1a;">
      ...
      <div style="background: #ffffff; padding: 32px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        ...
        <p style="margin: 0 0 20px; font-size: 15px; line-height: 1.6;">
          Here is your weekly forum digest for <strong>${periodLabel}</strong>.
        </p>
        ...
        <p style="margin: 0; font-size: 12px; color: #9ca3af; line-height: 1.6;">
          You are receiving this email because weekly forum digests are enabled on your IJF account.
        </p>
      </div>
    </div>
  `;
